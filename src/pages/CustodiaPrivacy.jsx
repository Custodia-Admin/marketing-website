      ...
      <section className="section-padding bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="container-custom">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact" className="bg-white text-green-600 hover:bg-gray-100 font-medium py-3 px-8 rounded-lg transition-all duration-200 transform hover:scale-105 whitespace-nowrap">
                Free Consultation
                <ArrowRight className="ml-2 w-5 h-5 inline" />
              </Link>
              <Link to="/services" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-green-600 font-medium py-3 px-8 rounded-lg transition-all duration-200 whitespace-nowrap">
                All Services
              </Link>
            </div>
          </motion.div>
